...
const AccountTutor = () => {
  return (
    <ContentContainer additionalClassName="w-full flex-grow bg-white rounded-lg p-6 md:ml-8">
      ...
      <InputText label="Nama" placeholder="Contoh: Admin Abdullah" />

      <InputText label="Email" placeholder="Masukkan Email Anda" />

      <InputText label="Nomor WA" placeholder="Contoh: 089871871724" />
      ...
      <InputText label="Desa" placeholder="Masukkan nama desa anda" />
      ...
      <InputText label="Perguruan Tinggi" placeholder="Nama Perguruan Tinggi" />

      <InputText label="Jurusan" placeholder="Jurusan" />
      ...
      <InputText label="Bank" placeholder="Masukkan nama bank anda" />

      <InputText label="Rekening" placeholder="Masukkan rekening anda" />
