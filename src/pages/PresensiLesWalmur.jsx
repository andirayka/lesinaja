...
const PresensiLesWalmur = () => {
  return (
    <div className="w-full md:ml-8">
      ...
      <CardItem title="Rabu, 7 Juli 2021, 08:00-09:30" containerClass="mt-8">
        <Button
          text="Ubah Jadwal"
          additionalClassName="bg-yellow-400 hover:bg-yellow-600 rounded-lg mt-5 ml-4 px-14 font-bold"
        />
        ...
        <SectionContent text="Rating Les">
          ...
          <Button
            text="Simpan Rating"
            additionalClassName="bg-yellow-400 hover:bg-yellow-600 rounded-lg mt-5"
          />
        </SectionContent>
        ...
        <SectionContent text="Data Perkembangan Siswa">
          ...
          <InputText
            label="Laporan"
            value="Terimakasih telah menyewa saya ya Om"
            disabled
          />
        </SectionContent>
      </CardItem>
